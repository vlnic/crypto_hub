defmodule CryptoHubWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CryptoHubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CryptoHubWeb.Gettext, "errors", msg, opts)
    end
  end
